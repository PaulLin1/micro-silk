...
export function SearchView({ blocks, query }: { blocks: Block[]; query: string }) {
    return (
            ...
            <div className="flex-1 p-5 flex justify-center">
                ...
                <div className="fixed bottom-6 left-[calc(50%+128px)] -translate-x-1/2 z-50">
                    <form
                        method="get"
                        action="/search"
                        className="w-200 h-30 rounded-4xl bg-[#181818]/95 backdrop-blur-xl p-5 flex flex-col shadow-2xl"
                    >
                        <input
                            type="text"
                            name="q"
